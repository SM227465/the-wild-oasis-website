...
export default function Page() {
  return (
    <div className='grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center'>
      <div className='col-span-3'>
        ...
        <div className='space-y-8'>
          <p>
            ...
            Dolomites, this is your paradise away from home. But it's not just about the luxury cabins. It's about the
          ...
          <p>
            This is where memorable moments are made, surrounded by nature's splendor. It's a place to slow down, relax,
      ...
      <div className='col-span-2'>
        <Image src={image2} placeholder='blur' quality={80} alt='Family that manages The Wild Oasis' />
      </div>
      ...
      <div className='col-span-3'>
        ...
        <div className='space-y-8'>
          ...
          <p>
            ...
            mountains with the personal touch only a family business can offer. Here, you're not just a guest; you're
            part of our extended family. So join us at The Wild Oasis soon, where tradition meets tranquility, and every
